...
namespace Darkages.Interfaces
{
    public interface IGameClient
    {
        ...
        void CheckChaos(TimeSpan elapsedTime);
        ...
        Task<GameClient> LearnSkill(Mundane source, SkillTemplate subject, string message);
        Task<GameClient> LearnSpell(Mundane source, SpellTemplate subject, string message);
