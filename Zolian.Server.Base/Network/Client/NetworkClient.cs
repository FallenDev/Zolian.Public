...
namespace Darkages.Network.Client
{
    public abstract class NetworkClient : IDisposable
    {
        ...
        public DateTime LastPacket0X13FromClient { get; set; }
        public DateTime LastPacket0X38FromClient { get; set; }
        public DateTime LastPacket0X1BFromClient { get; set; }
        public DateTime LastPacket0X2DFromClient { get; set; }
        ...
        public async void Send(NetworkFormat format)
        {
            ...
            try
            {
                ...
                if (ServerSetup.Config.LogClientPackets)
                    ...
                    case true:
                        {
                            ...
                            if (ServerSetup.Config.LogServerPackets)
