...
namespace Darkages.Network.Formats.Models.ServerFormats
{
    public class ServerFormat2E : NetworkFormat
    {
        ...
        public override void Serialize(NetworkPacketWriter writer)
        {
            ...
            if (ServerSetup.GlobalWorldMapTemplateCache.ContainsKey(_user.Client.Aisling.World))
            {
                var portal = ServerSetup.GlobalWorldMapTemplateCache[_user.Client.Aisling.World];
